                                    ...
                                    <div class="accordion-content ps-6 py-2.5 space-x-1">
                                        @foreach ($product->productSizes as $productSize)
                                            <div
                                                ...
                                                <label
                                                    for="size-{{strtolower($productSize->size)}}-{{$loop->parent->parent->index + 1}}-{{$loop->parent->index + 1}}"
                                                ...
                                                <input
                                                    autocomplete="off"
                                                    name="size-{{strtolower($productSize->size)}}-{{$loop->parent->parent->index + 1}}-{{$loop->parent->index + 1}}"
                                                    id="size-{{strtolower($productSize->size)}}-{{$loop->parent->parent->index + 1}}-{{$loop->parent->index + 1}}"
                                        ...
                                        @endforeach
                                        <button type="submit"
                                                id="update-{{$loop->parent->index + 1}}-{{$loop->index + 1}}"
