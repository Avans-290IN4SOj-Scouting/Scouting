...
@section('content')
    <body class="bg-gray-100">
        <div class="container mx-auto px-4 py-8">
            <h1 id="#edit-product-heading" class="text-3xl font-bold text-gray-700 font-semibold mb-4">{{ __('manage-products/products.page_title') }}</h1>
            ...
            <form action="{{ route('manage.products.edit.store', ['id' => $product->id]) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <label for="product-size-price" class="block text-gray-700 font-semibold">{{ __('manage-products/products.heading_custom_sizes') }}</label>
                        <div>
                            <div id="size-price-options" class="space-y-4">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <label for="same-price-all" class="ml-2 text-gray-700">{{ __('manage-products/products.custom_sizes_prices_label') }}</label>
                                </div>
                                <div id="size-price-inputs" class="hidden">
                                    <div id="specific-size-prices">
                                        <label class="block text-gray-700 font-semibold">{{ __('manage-products/products.custom_sizes_label') }}</label>
                        ...
                        @include('partials._input', [
                            ...
                            'placeholder' => __('manage-products/products.manage-products/products.category_input_placeholder'),
                            'id' => 'product-category',
                            'type' => 'text',
                            'name' => 'category',
                    ...
                    <div class="container mx-auto">
                        ...
                        <div id="file-upload-form" class="relative overflow-hidden bg-white rounded-lg shadow-md">
                            ...
                            <label for="af-submit-app-upload-images" id="drop-area"
                                ...
                                <span class="mt-2 block text-sm text-gray-800 dark:text-gray-200">{{ __('manage-products/products.product_image_span')}}</span>
