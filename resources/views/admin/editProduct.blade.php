                        ...
                        <label for="af-submit-app-upload-images" id="drop-area"
                            ...
                            <div class="flex justify-center items-center containerMaxH">
                                @if($product->image_path)
                                    <img id="file-image" src="{{ asset($product->image_path) }}" alt="Preview" class="containerMaxH">
                                @endif
                            </div>
                            ...
                            <button id="remove-image" class="hidden mt-2 bg-red-500 text-white px-4 py-2 rounded-md">{{ __('manage-products/products.product_image_delete_button') }}</button>
                        </label>
                    </div>
