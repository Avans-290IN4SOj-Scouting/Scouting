...
@section('content')
    <x-breadcrumbs :names="[__('manage-products/products.index_page_title')]"
                   :routes="[route('manage.products.index')]"/>
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-4">
            ...
            <a class="add-product-button" href="{{ route('manage.products.create.index') }}">
                <span
                    class="inline-flex justify-center items-center size-[37px] rounded-full bg-blue-600 text-white dark:bg-blue-500">
                ...
                <div class="border rounded-lg shadow overflow-hidden dark:border-gray-700 dark:shadow-gray-900">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <th scope="col"
                                class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-gray-400">
                                {{ __('manage-products/products.variety_heading') }}
                            </th>
                            <th scope="col"
