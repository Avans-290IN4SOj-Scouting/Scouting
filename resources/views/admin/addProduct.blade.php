...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        <h1 id="add-product-heading" class="text-3xl font-bold text-gray-700 font-semibold mb-4">Toevoegen product</h1>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <button  id="big-screen" type="submit"
                                 class="bg-blue-500 text-white submit-product px-4 py-2 big-screen rounded-md shadow-md hover:bg-blue-600 transition duration-300">
                            Product Toevoegen
                        </button>
                    </div>
                </div>
