...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        <h1 id="add-product-heading" class="text-3xl font-bold text-gray-700 font-semibold mb-4">{{ __('manage-products/products.page_title') }}</h1>
                                ...
                                <div id="specific-size-prices">
                                    ...
                                    @foreach ($baseProductSizes as $productSize)
                                        @include('partials._price-input', [
                                            ...
                                            'placeholder' => __('manage-products/products.custom_size_placeholder') . ' ' . $productSize->size,
