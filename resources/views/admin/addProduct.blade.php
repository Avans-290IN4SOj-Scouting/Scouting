...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
                <!-- Product Name Field -->
                @include('partials._input', ['label' => 'Product Naam', 'id' => 'product-name', 'type' => 'text', 'placeholder' => 'Product Naam'])
                <!-- Product Price Field -->
                @include('partials._price-input', ['label' => 'Product Prijs', 'id' => 'product-price', 'placeholder' => 'Prijs'])
                        ...
                        <div id="size-price-inputs" class="hidden">
                            ...
                            <div id="specific-size-prices">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <input type="number" placeholder="Prijs" class="w-full px-4 py-2 border border-gray-300 rounded-md specific-size-price">
                                </div>
                                <div class="flex items-center space-x-4">
                ...
                <div>
                    <textarea id="product-description" rows="4" class="w-full px-4 py-2 rounded-md shadow-md focus:outline-none focus:ring focus:border-blue-500 transition duration-300"></textarea>
                </div>
