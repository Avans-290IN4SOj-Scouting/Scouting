                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    @forelse($accounts as $account)
                        <tr class="h-[87px]">
                            ...
                            <td class="h-[87px] flex items-center gap-2 justify-end px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                <!--<div class="relative">
                                    ...
                                    <div id="selectRole-wrapper" class="relative w-[250px]"
                                        ...
                                        <select id="selectRole{{ $account->id }}" name="selectRole"
                                            ...
                                            @foreach($roles as $role)
                                                <option
                                                    value="{{ $role }}" {{ in_array($role, $account->roles->pluck('name')->toArray()) ? 'selected' : '' }}>
                                                    {{ $role }}
                                                </option>
                                            @endforeach
                                        </select>
