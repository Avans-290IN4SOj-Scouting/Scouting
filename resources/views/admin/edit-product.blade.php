        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <form action="{{ route('manage.products.edit.store', ['id' => $product->id]) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <x-singleselect :label="__('manage-products/products.category_input_label')" :placeholder="__('manage-products/products.category_input_placeholder')" :options="$baseCategories->pluck('type')" :value="$chosenCategory"
