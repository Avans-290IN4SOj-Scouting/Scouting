    ...
    <div class="flex flex-col w-max">
        <div class="flex flex-col sm:flex-row sm:items-center items-left justify-between">
            ...
            <form name="cancelOrderForm" method="POST" action="{{ route('manage.orders.cancel-order', ['id' => $order->id]) }}">
                @csrf
                <input dusk="cancel-order" type="submit" value="{{ __('manage-orders/order.cancel-order') }}" class="hover:cursor-pointer py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-700 dark:bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none">
            </form>
            @endif
        </div>
        <br>
            ...
            <div class="flex flex-col gap-4 bg-white border rounded-xl p-4 md:p-5 dark:bg-slate-900 dark:border-slate-700">
                ...
                <div class="flex gap-4 flex-col">
                    ...
                    <div class="max-w-sm">
                        ...
                        "optionClasses": "py-2 px-4 w-full text-sm text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-slate-800 dark:text-neutral-200 dark:focus:bg-neutral-800",
