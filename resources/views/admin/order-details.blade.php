                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                            ...
                            @foreach ($order->orderLines as $orderLine)
                                <tr>
                                        ...
                                        @if($admin)
                                            <div>
                                                <div class="flex rounded-lg ">
                                                    ...
                                                    <label for="product-price" class="sr-only">{{ __('manage-orders/order.price-per') }}</label>
                                                    <input type="number" id="product-price" step="0.01" value="{{ number_format($orderLine->product_price, 2)  }}"
                                    ...
                                    @if($admin)
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                                            <label for="trash" class="sr-only">{{ __('manage-orders/order.delete') }}</label>
