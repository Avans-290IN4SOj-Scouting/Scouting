                        ...
                        @foreach ($sizesWithPrices as $sizeWithPrice)
                            @if ($sizeWithPrice['size'] == 'Default')
                                ...
                                @include('partials._price-input', [
                                    ...
                                    'value' => $sizeWithPrice['price'], // Pass the default price value here
                                ])
                            @break
                        @endif
                    @endforeach
                                ...
                                <div id="specific-size-prices">
                                    ...
                                    @foreach ($sizesWithPrices as $sizeWithPrice)
                                        @include('partials._price-input', [
                                            ...
                                            'placeholder' => 'Prijs voor maat ' . $sizeWithPrice['size'],
