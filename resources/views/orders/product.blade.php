        ...
        <div class="single-product-view">
            ...
            <div class="info">
                ...
                <div class="actions">
                    ...
                    @if (count($product->productTypes) > 1)
                    <div class="relative">
                        <label for="product-types" class="hidden">{{ __('orders/orders.product') }} {{ __('orders/orders.type') }}</label>
                        <select id="product-types" name="product-types" class="peer p-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                        focus:pt-6
                        focus:pb-2
                        [&:not(:placeholder-shown)]:pt-6 [&:not(:placeholder-shown)]:pb-2
                        autofill:pt-6
                        ...
                        peer-[:not(:placeholder-shown)]:text-xs
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500">{{ __('orders/orders.type') }}</p>
                    </div>
                    @endif
