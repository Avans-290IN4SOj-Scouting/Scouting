<button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-{{ $color }}-600 text-white hover:bg-{{ $color }}-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-basic-modal">
    {{ $buttonText }}
</button>
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
                ...
                <form action="{{ $route }}" method="POST">
                    @csrf
                    <button type="submit" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-{{ $color }}-600 text-white hover:bg-{{ $color }}-700 disabled:opacity-50 disabled:pointer-events-none">
                        {{ $modalButton }}
                    </button>
                </form>
            </div>
