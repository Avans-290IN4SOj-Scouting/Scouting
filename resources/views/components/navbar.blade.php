            ...
            <div
                ...
                @if (Auth::user() && Auth::user()->hasRole('admin'))
                    <div
                        ...
                        <button type="button"
                                class="{{ request()->routeIs('manage.products') || request()->routeIs('manage.accounts.index') ? 'active-nav-link' : 'inactive-nav-link' }} flex items-center w-full sm:py-0">
                            {{__('navbar.admin')}}
                        ...
                        <div
                            ...
                            <a class="{{ request()->routeIs('manage.accounts.index') ? 'active-nav-link flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm' : 'inactive-nav-link flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm' }}"
