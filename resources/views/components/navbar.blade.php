    ...
    <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                {{--This are all links--}}
                <a class="{{ request()->routeIs('orders.overview') ? 'active-nav-link' : 'inactive-nav-link' }}"
                ...
                @if (Auth::user() && Auth::user()->hasRole('admin'))
                    <div
                        ...
                        <button type="button"
                                class="{{ request()->routeIs('manage-products') || request()->routeIs('manage-accounts') || request()->routeIs('manage-mails') ? 'active-nav-link' : 'inactive-nav-link' }} flex items-center w-full sm:py-0">
                            {{__('navbar.admin')}}
