        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <div
                    ...
                    <button type="button"
                        class="{{ request()->routeIs('manage-products') || request()->routeIs('manage-accounts') ? 'active-nav-link' : 'inactive-nav-link' }} flex items-center w-full sm:py-0 sm:border-s sm:border-gray-300 sm:ps-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500">
                        {{ __('navbar.admin') }}
                ...
                @guest
                    <div
                        class="flex items-center gap-x-2 font-medium text-gray-500  sm:border-s sm:border-gray-300 sm:my-6 sm:ps-6 dark:border-gray-700 dark:text-gray-400 ">
                        ...
                        <a class="hover:text-blue-600 dark:hover:text-blue-500" href="{{ route('login') }}">
                            {{-- This is the Login link --}}
                            {{ __('navbar.login') }}
                        </a>

                        <a class="hover:text-blue-600 dark:hover:text-blue-500"
                            href="{{ route('register') }}">
