            ...
            <div
                ...
                @if (Auth::user() && Auth::user()->hasRole('admin'))
                    <div
                        ...
                        <button type="button"
                                class="{{ request()->routeIs('manage.products.index') || request()->routeIs('manage.accounts.index') || request()->routeIs('manage.accounts.filter') ? 'active-nav-link' : 'inactive-nav-link' }} flex items-center w-full sm:py-0">
                            {{__('navbar.admin')}}
