...
@section('content')
    <div class="text-sm">
        <a href="/{{ __('route.track_orders') }}"
            class="flex flex-row items-center hover:text-blue-600 dark:text-white dark:fill-white">
        ...
        <div class="m-4">
            <div class="flex flex-col gap-4 lg:flex-row justify-between items-center w-full dark:text-white">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 items-center">
                    ...
                    <div class="p-2 rounded shadow dark:border dark:border-gray-700">{{ substr($order->order_date, 0, 11) }}
                    </div>
                </div>
                <div class="flex flex-col sm:flex-row justify-center gap-4 items-center">
                    <div>{{ __('orders/orders.total-price') }}</div>
                    <div class="p-2 rounded shadow dark:border dark:border-gray-700"><x-displayCurrency
                            :price="$total"></x-displayCurrency></div>
                </div>
    ...
    <div class="m-4 flex flex-row justify-center lg:justify-normal items-center">
        <button class="bg-red-600 text-white rounded p-2 hover:bg-red-900">{{ __('orders/orders.cancel-order') }}</button>
    </div>
